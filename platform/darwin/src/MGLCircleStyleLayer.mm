...
- (void)setCirclePitchAlignment:(NSExpression *)circlePitchAlignment {
    ...
    auto mbglValue = MGLStyleValueTransformer<mbgl::style::AlignmentType, NSValue *, mbgl::style::AlignmentType, MGLCirclePitchAlignment>().toPropertyValue(circlePitchAlignment);
...
- (void)setCircleScaleAlignment:(NSExpression *)circleScaleAlignment {
    ...
    auto mbglValue = MGLStyleValueTransformer<mbgl::style::CirclePitchScaleType, NSValue *, mbgl::style::CirclePitchScaleType, MGLCircleScaleAlignment>().toPropertyValue(circleScaleAlignment);
...
- (void)setCircleTranslationAnchor:(NSExpression *)circleTranslationAnchor {
    ...
    auto mbglValue = MGLStyleValueTransformer<mbgl::style::TranslateAnchorType, NSValue *, mbgl::style::TranslateAnchorType, MGLCircleTranslationAnchor>().toPropertyValue(circleTranslationAnchor);
